...
<section class="section">
    <div class="container">
        <ul class="breadcrumb mb-8 inline-flex h-8 items-center justify-center space-x-2 rounded-3xl bg-theme-light px-4 py-2 lg:hidden">
            ...
            <li class="leading-none text-dark">
                <span class="text-sm leading-none">/ Visi dan Misi</span>
            </li>
        </ul>
        <div class="row">
            ...
            <div class="mt-10 lg:col-6 lg:order-1 lg:mt-0">
                ...
                <div class="content text-justify-content">
                    <p class="mt-6">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat sit laudantium ratione dicta voluptate vero eaque pariatur minima dolor ipsum voluptas, delectus dignissimos quasi quis sapiente! Fugit ducimus tempore itaque sit aperiam, eos quia culpa ratione commodi voluptates aut corrupti voluptatum sed repellat laboriosam recusandae eveniet soluta, iure, tenetur ab?
                    </p>
                </div>
            </div>
        </div>
